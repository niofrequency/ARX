...
const LORA_OPTIONS = [
  ...
  { id: "hairypussyv3.safetensors", name: "HRYPSY3" },{ id: "hairypussyv4.safetensors", name: "HRYPSY4" },{ id: "hairypussyv5.safetensors", name: "HRYPSY5" },{ id: "hairypussyv7.safetensors", name: "HRYPSY7" },
