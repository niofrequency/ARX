...
const LORA_OPTIONS = [
  ...
  { id: "hairypussy.safetensors", name: "HRYPSY" }, { id: "hairypussy2.safetensors", name: "HRYPSY2" },{ id: "hairypussyv3.safetensors", name: "HRYPSY3" },{ id: "hairypussyv4.safetensors", name: "HRYPSY4" },
